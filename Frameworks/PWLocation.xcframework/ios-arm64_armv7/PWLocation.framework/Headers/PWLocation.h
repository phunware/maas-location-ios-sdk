...
#import <PWLocation/PWMistLocationManager.h>
#import <PWLocation/PWBeaconPointLocationManager.h>
...
static NSString * const PWLocationVersion = @"3.10.0";
static NSString * const PWLocationAlgoVersion = @"2.4";
